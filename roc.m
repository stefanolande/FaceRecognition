...
if p<=alpha
    ...
    if verbose
        ...
        fprintf('1) Max Sensitivity Cut-off point= %0.5f\n',table(CSe,1))
        fprintf('2) Max Specificity Cut-off point= %0.5f\n',table(CSp,1))
        fprintf('3) Cost effective Cut-off point= %0.5f\n',CE), 
        fprintf('4) Max Efficiency Cut-off point= %0.5f\n',table(CEff,1))
